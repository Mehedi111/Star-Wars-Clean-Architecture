...
import com.ms.starwars.di.module.UrlProviderModule_ProvideUrlFactory;
...
import com.ms.starwars.ui.details.DetailsActivity_MembersInjector;
import com.ms.starwars.ui.details.DetailsViewModel_AssistedFactory;
import com.ms.starwars.ui.details.DetailsViewModel_AssistedFactory_Factory;
...
public final class DaggerBaseApplication_HiltComponents_ApplicationC extends BaseApplication_HiltComponents.ApplicationC {
  ...
  private String getNamedString() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = namedString;
        if (local instanceof MemoizedSentinel) {
          local = UrlProviderModule_ProvideUrlFactory.provideUrl();
  ...
  public static final class Builder {
     ...
     */
    @Deprecated
    public Builder urlProviderModule(UrlProviderModule urlProviderModule) {
      Preconditions.checkNotNull(urlProviderModule);
      return this;
    }
  ...
  private final class ActivityRetainedCImpl extends BaseApplication_HiltComponents.ActivityRetainedC {
    ...
    private final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
      ...
      private DetailsViewModel_AssistedFactory getDetailsViewModel_AssistedFactory() {
        return DetailsViewModel_AssistedFactory_Factory.newInstance(DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfListOfSpecieProvider(), DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfPlanetProvider(), DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfListOfFilmProvider());
      }
      ...
      private HomeViewModel_AssistedFactory getHomeViewModel_AssistedFactory() {
        return HomeViewModel_AssistedFactory_Factory.newInstance(DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfListOfCharacterProvider());
      }
      ...
      private Map<String, Provider<ViewModelAssistedFactory<? extends ViewModel>>> getMapOfStringAndProviderOfViewModelAssistedFactoryOf(
        ...
        return MapBuilder.<String, Provider<ViewModelAssistedFactory<? extends ViewModel>>>newMapBuilder(2).put("com.ms.starwars.ui.details.DetailsViewModel", (Provider) getDetailsViewModel_AssistedFactoryProvider()).put("com.ms.starwars.ui.home.HomeViewModel", (Provider) getHomeViewModel_AssistedFactoryProvider()).build();
      }
  ...
  private final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        ...
        return (T) DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfListOfSpecie();

        case 1: // com.ms.domain.usecase.BaseUseCase<java.lang.String,kotlinx.coroutines.flow.Flow<com.ms.domain.models.Planet>> 
        return (T) DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfPlanet();
        ...
        return (T) DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfListOfFilm();
        ...
        return (T) DaggerBaseApplication_HiltComponents_ApplicationC.this.getBaseUseCaseOfStringAndFlowOfListOfCharacter();
